    ...
    const filteredStudents = useMemo(() => {
        return students.filter(student => {
            ...
            return searchMatch && levelMatch && locationMatch && paymentTypeMatch && periodicityMatch && dateFromMatch && dateToMatch && tagsMatch && authsMatch && advancedMatch;
             ...
             // Ordenar alfabéticamente por Nombre primero, luego por Apellido
             const nameCompare = a.firstName.localeCompare(b.firstName, 'es', { sensitivity: 'base' });
                        ...
                        <table className="min-w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                {filteredStudents.map(student => {
                                    ...
                                    // Calculate total attendance count strictly up to today
                                    const totalAttendanceCount = attendanceRecords.filter(ar => {
