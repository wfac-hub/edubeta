    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                ...
                <span className="font-semibold text-gray-500 dark:text-gray-400">{defaultConcepts.length} Resultados</span>
            </div>
                ...
                <table className="min-w-full text-sm text-left">
                    ...
                    <tbody className="divide-y divide-gray-200 dark:divide-slate-700">
                         {defaultConcepts.length === 0 && (
                            <tr>
                                <td colSpan={4} className="text-center py-10 text-gray-500 dark:text-gray-400">0 Resultados</td>
                            </tr>
                        )}
                    </tbody>
                </table>
