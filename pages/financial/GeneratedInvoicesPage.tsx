...
const GeneratedInvoicesPage = () => {
    ...
    // FIX: This function had incorrect type guarding, leading to a TypeScript error.
    // Corrected to use `isCompany` to differentiate between entity types.
                ...
                <table className="min-w-full text-sm text-left">
                    ...
                    <tbody className="divide-y divide-gray-200 dark:divide-slate-700">
                        {combinedInvoices.map(item => {
                            ...
                            const totalAmount = isProforma ? (item as unknown as ProformaInvoice).total : (item as unknown as Invoice).totalAmount;
