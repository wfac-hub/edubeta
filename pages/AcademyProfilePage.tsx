...
const AcademyProfilePage = () => {
    ...
    const handleFileUpdate = (fieldName: keyof AcademyProfile, content: string | null) => {
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <Card>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                    <FileUploadField
                        ...
                        onChange={(value) => handleFileUpdate('logoBase64', value)}
                    ...
                    <FileUploadField
                        ...
                        onChange={(value) => handleFileUpdate('docLogoBase64', value)}
                        helpText={<>Tamaño máximo: 800 KB<br/>Tipos de archivo aceptados: .jpg, .png, .jpeg</>}
                        acceptedTypes={['image/jpeg', 'image/png']}
                        maxSizeKB={800}
                    />
                ...
                <div className="mt-6">
                     <FileUploadField
                        ...
                        onChange={(value) => handleFileUpdate('directorSignatureBase64', value)}
                        helpText={<>Tamaño máximo: 800 KB<br/>Tipos de archivo aceptados: .jpg, .png, .jpeg</>}
                        acceptedTypes={['image/jpeg', 'image/png']}
                        maxSizeKB={800}
                    />
            ...
            <Card title="Área de alumnos" icon={<UserSquare size={20} />}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <FileUploadField label="Imagen fondo área de alumnos" value={formData.studentAreaBackground} onChange={v => handleFileUpdate('studentAreaBackground', v)} acceptedTypes={imageTypes} maxSizeKB={2000} helpText={<>Tamaño máximo: 2 MB<br/>Tipos de archivo aceptados: .jpg, .png, .jpeg, .svg</>} />
                    <FileUploadField label="Logo área de alumnos" value={formData.studentAreaLogo} onChange={v => handleFileUpdate('studentAreaLogo', v)} acceptedTypes={imageTypes} maxSizeKB={800} helpText={<>Tamaño máximo: 800 KB<br/>Tipos de archivo aceptados: .jpg, .png, .jpeg</>} />
                </div>
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 mt-4">
