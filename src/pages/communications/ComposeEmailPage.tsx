                ...
                <div className="p-4 md:p-10 bg-gray-100 dark:bg-slate-900 flex justify-center">
                     <div className="bg-white w-full shadow-lg border border-gray-200 mx-auto rounded-md overflow-hidden flex flex-col max-w-[700px]">
                        ...
                        <div className="p-8 md:p-12 text-gray-800 font-sans flex-grow bg-white min-h-[300px]">
                            ...
                            <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed" dangerouslySetInnerHTML={{ __html: sanitizeHTML(getProcessedContent(body) || '<p class="text-gray-400 italic">Escribe tu mensaje...</p>') }} />
                        </div>
                        ...
                        <div className="bg-gray-50 border-t border-gray-200 p-8 mt-auto">
                            ...
                            <div className="text-xs text-gray-500 text-center leading-relaxed max-w-2xl mx-auto space-y-2" dangerouslySetInnerHTML={{ __html: sanitizeHTML(academyProfile.emailFooterText || '<p>Texto legal del pie de página...</p>') }} />
                        </div>
                    </div>
                </div>
            </div>
