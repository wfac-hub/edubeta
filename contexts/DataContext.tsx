...
export const DataProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const addEnrollments = async (enrollmentsData: NewEnrollment[]) => {
        ...
        enrollmentsData.forEach(enrollment => {
            ...
            classes.forEach(c => {
                ...
                // We do NOT delete old records here anymore to avoid complexity/bugs.
    ...
    const addResource = async (f: File, s: string, id?: number) => {};
    ...
    const updateCourseClass = (c: CourseClass) => updateItem(setCourseClasses, c as any, 'course_classes', courseClassTransform);
