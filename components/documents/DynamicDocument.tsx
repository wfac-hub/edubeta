    ...
    const allSections = [
        ...
        { condition: academyProfile.sendTermsAndConditions, content: (
            <>
                ...
                <main>
                    <div className="text-xs space-y-2 text-justify prose prose-sm max-w-none" dangerouslySetInnerHTML={{ __html: replacePlaceholders(academyProfile.termsAndConditionsText) }}></div>
                </main>
            </>
        )},
        { condition: academyProfile.sendDataProtection, content: (
             <>
                ...
                <main>
                    <div className="text-xs space-y-2 text-justify prose prose-sm max-w-none" dangerouslySetInnerHTML={{ __html: replacePlaceholders(academyProfile.dataProtectionText) }}></div>
                </main>
            </>
        )},
        ...authsToRender.map(auth => ({
            ...
            content: (
                 <>
                    ...
                    <main>
                         <div className="text-xs space-y-2 text-justify prose prose-sm max-w-none" dangerouslySetInnerHTML={{ __html: replacePlaceholders(auth.documentText) }}></div>
                    </main>
                </>
            )
        }))
